<?php \ProtoneMedia\Splade\Facades\SEO::title(__('Подписки')); ?>
...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="w-full flex items-center justify-between">
            ...
            <a href="<?php echo e(route('subscriptions.create')); ?>" class="bg-gray-300 hover:bg-gray-600 hover:text-white text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center"><?php echo e(__('Новая подписка')); ?></a>
        </div>
     <?php $__env->endSlot(); ?>
