        ...
        <div class="header__inner">
            <div class="header__logo">
                <a href="#" class="header__logo-link">
                    <img src="<?php echo e(asset('/assets/img/79ecf04b67f1c2c76d60.svg')); ?>" alt="" class="header__logo-img">
                </a>
            </div>
...
<?php /**PATH C:\OSPanel\domains\Ishak\resources\views/client/include/header.blade.php ENDPATH**/ ?>