<?php \ProtoneMedia\Splade\Facades\SEO::title(__('Новая соц-сеть')); ?>
     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="w-full flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <?php echo e(__('Новая соц-сеть')); ?>

            </h2>
            <a href="<?php echo e(route('socials.index')); ?>" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center"><?php echo e(__('К соц-сетей ')); ?></a>
        </div>
         <?php $__env->endSlot(); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => ''.e(route('socials.store')).'']); ?>
...
<?php $component = ProtoneMedia\Splade\Components\Form\Input::resolve(['name' => 'link','label' => ''.e(__('Ссылка на соц-сеть')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['placeholder' => ''.e(__('vk.com/ваша соц-сеть')).'']); ?>
...
<?php $component = ProtoneMedia\Splade\Components\Form\File::resolve(['name' => 'image','showFilename' => false,'preview' => true,'label' => ''.e(__('Изображение соц-сети')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = ProtoneMedia\Splade\Components\Form\Select::resolve(['name' => 'isActive','label' => ''.e(__('Статус соц-сети')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                    <option value="0"><?php echo e(__('Не активена')); ?></option>
                    <option value="1"><?php echo e(__('Активена')); ?></option>
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\OSPanel\domains\Ishak\resources\views/Admin/socials/create.blade.php ENDPATH**/ ?>