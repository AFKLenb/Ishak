<?php \ProtoneMedia\Splade\Facades\SEO::title(__('Настройки')); ?>
...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="w-full flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight"><?php echo e(__('Настроки')); ?></h2>
            <a href="<?php echo e(route('settings.create')); ?>" class="bg-gray-300 hover:bg-gray-600 hover:text-white text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center"><?php echo e(__('Новая настройка')); ?></a>
        </div>
     <?php $__env->endSlot(); ?>
...
<?php $component = ProtoneMedia\Splade\Components\Table::resolve(['for' => $settings] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                <?php $__env->slot('spladeTableCell96d6f2e7e1f705ab5e59c84a6dc009b2', function ($settings) use ($__env) { ?>
                    <img class="max-w-[35px] rounded-full max-h-[35px] mt-[15px] mb-[15px]" src="<?php echo e(Storage::url($settings->logo)); ?>" alt="">
                <?php }); ?>
...
<?php /**PATH C:\OSPanel\domains\Ishak\resources\views/Admin/settings/index.blade.php ENDPATH**/ ?>