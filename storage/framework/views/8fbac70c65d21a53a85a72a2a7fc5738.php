<?php \ProtoneMedia\Splade\Facades\SEO::title(__('Редактировать услугу')); ?>
     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="w-full flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <?php echo e(__('Редактирование продукта')); ?> <?php echo e($product->title); ?>

            </h2>
            <a href="<?php echo e(route('products.index')); ?>" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center"><?php echo e(__('К списку услуг')); ?></a>
        </div>
         <?php $__env->endSlot(); ?>
...
<?php $component = ProtoneMedia\Splade\Components\Form::resolve(['default' => $product] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['method' => 'PUT','action' => ''.e(route('products.update', $product->id)).'']); ?>
...
<?php endif; ?>
                <img class="max-w-[150px] rounded-md max-h-[150px] mt-[15px] mb-[15px]" src="<?php echo e(Storage::url($product->image)); ?>" alt="">
                <?php if (isset($component)) { $__componentOriginal10476663a3271f48a2be05c903a73050 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal10476663a3271f48a2be05c903a73050 = $attributes; } ?>
...
<?php endif; ?>
<?php /**PATH C:\OSPanel\domains\Ishak\resources\views/Admin/products/edit.blade.php ENDPATH**/ ?>